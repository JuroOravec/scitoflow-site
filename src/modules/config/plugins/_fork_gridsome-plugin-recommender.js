// This is a fork of gridsome-plugin-recommender plugin@1.1.5
// Because it wasn't working with vue-remark
// See https://github.com/mklueh/gridsome-plugin-recommender/issues/5.
// 
// This fork can be replaced with an npm package once
// this MR is in and released
// https://github.com/mklueh/gridsome-plugin-recommender/pull/33

const _ = require("lodash");
const pluginName = 'gridsome-plugin-feed';
